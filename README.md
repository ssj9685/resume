...
제강업체 입출고관리 및 공정데이터 정규화 웹서비스 구축
Spring BootThymeleaf
제강업체 입출고관리 및 공정데이터 정규화 웹서비스 구축
프론트엔드 개발을 담당하였습니다. Spring Boot와 잘 맞는 Thymeleaf를 활용하여 템플릿을 구성하였습니다. 입출고관리 및 공정데이터를 정규화하는 웹서비스를 제공하는 과정에 테이블 데이터 및 반복되는 데이터를 효율적으로 다루기 위한 자체 프레임워크를 제작하였습니다.

팀 구성 ― 프론트엔드 개발1, 백엔드 개발1
https://github.com/cbnu-easw2020/steel-erp
2021
제강업체 입출고관리 및 공정데이터 정규화 앱
AndroidFCM(Firebase Cloud Messaging)ZXing
제강업체 입출고관리 및 공정데이터 정규화 앱
...
https://play.google.com/store/apps/details?id=kr.easw.steelERP.app
https://github.com/cbnu-easw2020/steel-erp-app
2020
실비보험 청구 간소화 소프트웨어 및 드라이브 스루 의약품 투약 및 실비보험 청구 시스템
ReactJSSpring BootRedux.jsWebSocket
실비보험 청구 간소화 소프트웨어 및 드라이브 스루 의약품 투약 및 실비보험 청구 시스템
프론트 엔드 개발을 맡았고 실비보험 청구 간소화 웹의 전반적인 디자인 및 기능을 담당했습니다. React와 redux를 활용하여 SPA로 구현하였고 서버와 데이터를 주고 받을 때의 state를 관리하여 해당 정보를 유지하도록 하였습니다.
실비보험 청구 웹과 더불어 드라이브 스루 패널과 투약시의 약국 대시보드의 웹 또한 만들었는데 websocket을 활용하여 QR코드 데이터가 읽히는 것을 인식하여 패널과 대시보드가 실시간으로 상호작용 할 수 있도록 하였습니다.

팀 구성 ― 프론트엔드 개발1, 백엔드 개발1
https://github.com/cbnu-easw2020/dt-mic
